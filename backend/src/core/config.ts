...
export const getConfig = (key: string, defaultValue?: string): string | never => {
...
export const getConfigNumber = (key: string, defaultValue?: number): number | never =>
  Number(getConfig(key, defaultValue?.toString()))
